...
{
    public class TestFormatsDE : BaseTestFormats
    {
        ...
        {
            Assert.Equal("Alle 5 Minuten, um 15:00, Montag bis Freitag", GetDescription("*/5 15 * * MON-FRI"));
        }
        ...
        {
            Assert.Equal("Um 07:05, every 3 days of the week, Dienstag bis Samstag", GetDescription("0 5 7 ? * 2/3 *"));
        }
