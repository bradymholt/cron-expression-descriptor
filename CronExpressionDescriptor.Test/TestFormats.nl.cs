...
namespace CronExpressionDescriptor.Test
{
    ...
    public class TestFormatsNL
    {
        ...
        {
            Assert.AreEqual("Om 11:00 PM, maandag t/m vrijdag", ExpressionDescriptor.GetDescription("0 23 ? * MON-FRI"));
        }
        ...
        {
            Assert.AreEqual("Om 11:30 AM, maandag t/m vrijdag", ExpressionDescriptor.GetDescription("30 11 * * 1-5"));
        }
        ...
        {
            Assert.AreEqual("Om 11:30 AM", ExpressionDescriptor.GetDescription("30 11 * * *"));
        }
        ...
        {
            Assert.AreEqual("Om 02:30 PM en 04:30 PM", ExpressionDescriptor.GetDescription("30 14,16 * * *"));
        }
        ...
        {
            Assert.AreEqual("Om 06:30 AM, 02:30 PM en 04:30 PM", ExpressionDescriptor.GetDescription("30 6,14,16 * * *"));
        }
        ...
        {
            Assert.AreEqual("Om 09:46 AM, alleen op maandag", ExpressionDescriptor.GetDescription("46 9 * * 1"));
        }
        ...
        {
            Assert.AreEqual("Om 12:23 PM, op dag 15 van de maand", ExpressionDescriptor.GetDescription("23 12 15 * *"));
        }
        ...
        {
            Assert.AreEqual("Om 12:23 PM, alleen in januari", ExpressionDescriptor.GetDescription("23 12 * JAN *"));
        }
        ...
        {
            Assert.AreEqual("Om 12:23 PM, januari t/m februari", ExpressionDescriptor.GetDescription("23 12 * JAN-FEB *"));
        }
        ...
        {
            Assert.AreEqual("Om 12:23 PM, januari t/m maart", ExpressionDescriptor.GetDescription("23 12 * JAN-MAR *"));
        }
        ...
        {
            Assert.AreEqual("Om 12:23 PM, alleen op zondag", ExpressionDescriptor.GetDescription("23 12 * * SUN"));
        }
        ...
        {
            Assert.AreEqual("Elke 05 minuten, om 03:00 PM, maandag t/m vrijdag", ExpressionDescriptor.GetDescription("*/5 15 * * MON-FRI"));
        }
        ...
        {
            Assert.AreEqual("Om 02:02:30 PM", ExpressionDescriptor.GetDescription("30 02 14 * * *"));
        }
        ...
        {
            Assert.AreEqual("Om 30 seconden na de minuut, elke 05 minuten", ExpressionDescriptor.GetDescription("30 */5 * * * *"));
        }
        ...
        {
            Assert.AreEqual("Om 30 minuten na het uur, tussen 10:00 AM en 02:00 PM, alleen op woensdag en vrijdag", ExpressionDescriptor.GetDescription("0 30 10-13 ? * WED,FRI"));
        }
        ...
        {
            Assert.AreEqual("Om 10 seconden na de minuut, elke 05 minuten", ExpressionDescriptor.GetDescription("10 0/5 * * * ?"));
        }
        ...
        {
            Assert.AreEqual("Elke 03 minuten, minuut 02 t/m 59 na het uur, om 01:00 AM, 09:00 AM, en 10:00 PM, tussen dag 11 en 26 van de maand, januari t/m juni", ExpressionDescriptor.GetDescription("2-59/3 1,9,22 11-26 1-6 ?"));
        }
        ...
        {
            Assert.AreEqual("Om 06:00 AM", ExpressionDescriptor.GetDescription("0 0 6 1/1 * ?"));
        }
        ...
        {
            Assert.AreEqual("Om 05 minuten na het uur", ExpressionDescriptor.GetDescription("0 5 0/1 * * ?"));
        }
        ...
        {
            Assert.AreEqual("Om 12:23 PM, januari t/m februari, 2013 t/m 2014", ExpressionDescriptor.GetDescription("23 12 * JAN-FEB * 2013-2014"));
        }
        ...
        {
            Assert.AreEqual("Om 12:23 PM, januari t/m maart, 2013 t/m 2015", ExpressionDescriptor.GetDescription("23 12 * JAN-MAR * 2013-2015"));
        }
        ...
        {
            Assert.AreEqual("Om 12:23 PM, op de tweede zondag van de maand", ExpressionDescriptor.GetDescription("23 12 * * SUN#2"));
        }
        ...
        public void TestDayOfWeekModifierWithSundayStartOne()
        {
            ...
            Assert.AreEqual("Om 12:23 PM, op de tweede zondag van de maand", ExpressionDescriptor.GetDescription("23 12 * * 1#2", options));
        }
        ...
        {
            Assert.AreEqual("Om 25 minuten na het uur, elke 13 uur, tussen 07:00 AM en 07:00 PM", ExpressionDescriptor.GetDescription("0 25 7-19/13 ? * *"));
        }
        ...
        {
            Assert.AreEqual("Om 25 minuten na het uur, elke 13 uur, tussen 07:00 AM en 08:00 PM", ExpressionDescriptor.GetDescription("0 25 7-20/13 ? * *"));
        }
    }
}