namespace CronExpressionDescriptor.Test
{
    ...
    public class TestFormatsRO
    {
        ...
        {
           Harness(cron: "0 23 ? * MON-FRI", expected: "La 11:00 după amiază, de luni până vineri"
               , expectedVerbose: "La 11:00 după amiază, în fiecare zi, de luni până vineri");            
        }
        ...
        {
            Harness(cron: "30 14,16 * * *", expected: "La 02:30 după amiază și 04:30 după amiază",
                expectedVerbose: "La 02:30 după amiază și 04:30 după amiază, în fiecare zi, în fiecare zi");  
        }
        ...
        public void TestThreeTimesDaily()
        {
            Harness(cron:"30 6,14,16 * * *",
                expected: "La 06:30, 02:30 după amiază și 04:30 după amiază",
                expectedVerbose: "La 06:30, 02:30 după amiază și 04:30 după amiază, în fiecare zi, în fiecare zi");
        }
        ...
        public void TestDayOfMonth()
        {
            Harness(cron: "23 12 15 * *", 
                expected: "La 12:23 după amiază, în ziua 15 a lunii", 
                expectedVerbose: "La 12:23 după amiază, în ziua 15 a lunii, în fiecare zi");
        }

        [Test]
        public void TestMonthName()
        {
            Harness(cron: "23 12 * JAN *", expected: "La 12:23 după amiază, doar în Ianuarie",
                expectedVerbose: "La 12:23 după amiază, în fiecare zi, în fiecare zi, doar în Ianuarie");
        }

        [Test]
        public void TestDayOfMonthWithQuestionMark()
        {
            Harness(cron: "23 12 ? JAN *", expected: "La 12:23 după amiază, doar în Ianuarie", expectedVerbose: "La 12:23 după amiază, în fiecare zi, în fiecare zi, doar în Ianuarie");
        }
        ...
        public void TestMonthNameRange2()
        {
            Harness(cron:"23 12 * JAN-FEB *",
                expected: "La 12:23 după amiază, din Ianuarie până în Februarie",
                expectedVerbose: "La 12:23 după amiază, în fiecare zi, în fiecare zi, din Ianuarie până în Februarie");
        }

        [Test]
        public void TestMonthNameRange3()
        {
            Harness(cron: "23 12 * JAN-MAR *", expected: "La 12:23 după amiază, din Ianuarie până în Martie",
                expectedVerbose: "La 12:23 după amiază, în fiecare zi, în fiecare zi, din Ianuarie până în Martie");
        }

        [Test]
        public void TestDayOfWeekName()
        {
            Harness(cron: "23 12 * * SUN", expected: "La 12:23 după amiază, doar duminică", expectedVerbose: "La 12:23 după amiază, în fiecare zi, doar duminică");
        }
        ...
        public void TestDayOfWeekRange()
        {
            Harness(cron: "*/5 15 * * MON-FRI", 
                expected: "La fiecare 5 minute, la 03:00 după amiază, de luni până vineri",
                expectedVerbose: "La fiecare 5 minute, la 03:00 după amiază, în fiecare zi, de luni până vineri");
        }
        ...
        public void TestTimeOfDayWithSeconds()
        {
            Harness(cron: "30 02 14 * * *",
                expected: "La 02:02:30 după amiază",
                expectedVerbose: "La 02:02:30 după amiază, în fiecare zi, în fiecare zi");
        }
        ...
        public void TestSecondMinutesHoursIntervals()
        {
            Harness(cron: "5-10 30-35 10-12 * * *",
                expected: "Între secunda 5 și secunda 10, între minutele 30 și 35, între 10:00 și 12:59 după amiază",
                expectedVerbose: "Între secunda 5 și secunda 10, între minutele 30 și 35, între 10:00 și 12:59 după amiază, în fiecare zi, în fiecare zi");
        }
        ...
        public void TestMinutesPastTheHourRange()
        {
            Harness(cron: "0 30 10-13 ? * WED,FRI", 
                expected: "La și 30 de minute, între 10:00 și 01:59 după amiază, doar miercuri și vineri",
                expectedVerbose: "La și 30 de minute, între 10:00 și 01:59 după amiază, în fiecare zi, doar miercuri și vineri");            
        }
        ...
        public void TestBetweenWithInterval()
        {
            ...
            Harness( cron: "2-59/3 1,9,22 11-26 1-6 ?",
                expected: "La fiecare 3 minute, între minutele 2 și 59, la 01:00, 09:00, și 10:00 după amiază, între zilele 11 și 26 ale lunii, din Ianuarie până în Iunie", 
                expectedVerbose: "La fiecare 3 minute, între minutele 2 și 59, la 01:00, 09:00, și 10:00 după amiază, între zilele 11 și 26 ale lunii, în fiecare zi, din Ianuarie până în Iunie");
        }
        ...
        public void TestYearRange2()
        {
            Harness (cron:"23 12 * JAN-FEB * 2013-2014",
                expected: "La 12:23 după amiază, din Ianuarie până în Februarie, din 2013 până în 2014",
                expectedVerbose: "La 12:23 după amiază, în fiecare zi, în fiecare zi, din Ianuarie până în Februarie, din 2013 până în 2014");
        }
        ...
        public void TestYearRange3()
        {
            Harness (cron:"23 12 * JAN-MAR * 2013-2015",
                expected: "La 12:23 după amiază, din Ianuarie până în Martie, din 2013 până în 2015",
                expectedVerbose: "La 12:23 după amiază, în fiecare zi, în fiecare zi, din Ianuarie până în Martie, din 2013 până în 2015");
        }
        ...
        public void TestHourRange()
        {
            Harness(cron: "0 0/30 8-9 5,20 * ?",
                ...
                expectedVerbose: "La fiecare 30 minute, între 08:00 și 09:59, în ziua 5 și 20 a lunii, în fiecare zi");
        }
        ...
        public void TestDayOfWeekModifier()
        {
            Harness(cron: "23 12 * * SUN#2", 
                expected: "La 12:23 după amiază, în a doua duminică a lunii", 
                expectedVerbose: "La 12:23 după amiază, în fiecare zi, în a doua duminică a lunii");
        }

        [Test]
        public void TestDayOfWeekModifierWithSundayStartOne()
        {
            Assert.AreEqual("La 12:23 după amiază, în a doua duminică a lunii",
        ...
        public void TestHourRangeWithEveryPortion()
        {
            Harness(cron: "0 25 7-19/13 ? * *", 
                expected: "La și 25 de minute, la fiecare 13 ore, între 07:00 și 07:59 după amiază",
                expectedVerbose: "La și 25 de minute, la fiecare 13 ore, între 07:00 și 07:59 după amiază, în fiecare zi, în fiecare zi");
        }
        ...
        public void TestHourRangeWithTrailingZeroWithEveryPortion()
        {
            Harness(cron: "0 25 7-20/13 ? * *",
               expected: "La și 25 de minute, la fiecare 13 ore, între 07:00 și 08:59 după amiază",
               expectedVerbose: "La și 25 de minute, la fiecare 13 ore, între 07:00 și 08:59 după amiază, în fiecare zi, în fiecare zi");
        }
        ...
        public void TestEvery3Day()
        {
            Harness(cron: "0 0 8 1/3 * ? *", 
                ...
                expectedVerbose: "La 08:00, la fiecare 3 zile, în fiecare zi");
        }
        ...
        public void TestEvery3Month()
        {
            Harness(cron: "0 5 7 2 1/3 ? *", 
                ...
                expectedVerbose: "La 07:05, în ziua 2 a lunii, în fiecare zi, la fiecare 3 luni");
        }
        ...
        public void TestEvery2Years()
        {
            Harness(cron: "0 15 6 1 1 ? 1/2",
                ...
                expectedVerbose: "La 06:15, în ziua 1 a lunii, în fiecare zi, doar în Ianuarie, o dată la 2 ani");
        }
        ...
        public void TestMutiPartRangeSeconds2()
        {
            Harness(cron: "2,26-28 18 * * *",
                expected: "La și 2 și de 26 până 28 minute, la 06:00 după amiază",
                expectedVerbose: "La și 2 și de 26 până 28 minute, la 06:00 după amiază, în fiecare zi, în fiecare zi");            
        }
