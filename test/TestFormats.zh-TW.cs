...
namespace CronExpressionDescriptor.Test
{
    ...
    public class TestFormatsTW : Support.BaseTestFormats
    {
        ...
        {
            Assert.Equal("每分鐘, 僅在 三月", GetDescription("* * * 3 *"));
        }

        [Fact]
        public void TestTwoMonthsOnly()
        {
            Assert.Equal("每分鐘, 僅在 三月 和 六月", GetDescription("* * * 3,6 *"));
        }
        ...
        {
            Assert.Equal("在 12:23 PM, 僅在 一月", GetDescription("23 12 * JAN *"));
        }
        ...
        {
            Assert.Equal("每 5 分鐘, 每月的最後一天, 僅在 一月", GetDescription("*/5 * L JAN *"));
        }
        ...
        {
            Assert.Equal("每 3 分鐘, 在每小時的 2 到 59 分鐘, 在 01:00 AM, 09:00 AM, 和 10:00 PM, 在每月的 11 和 26 號之間, 一月 到 六月", GetDescription("2-59/3 1,9,22 11-26 1-6 ?"));
        }
